...
export default function LeaderboardPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 relative overflow-hidden py-8 px-4 md:px-8">
      {/* Gambar Latar Belakang Siswa Leaderboard */}
      <img
        src="/images/siswa-quiz-bg.jpg"
        alt="Background Leaderboard Siswa"
      ...
      <div className="fixed top-0 left-10 w-[500px] h-[500px] bg-yellow-500/10 rounded-full blur-[140px] pointer-events-none z-[2]" />
