...
export default function KosakataPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 relative overflow-hidden py-8 px-4 md:px-8">
      {/* Gambar Latar Belakang Siswa Kosakata */}
      <img
        src="/images/siswa-kosakata-bg.jpg"
        alt="Background Siswa Kosakata"
      ...
      <div className="fixed top-0 left-10 w-[500px] h-[500px] bg-cyan-600/15 rounded-full blur-[140px] pointer-events-none z-[2]" />
      <div className="fixed bottom-0 right-10 w-[500px] h-[500px] bg-indigo-600/15 rounded-full blur-[140px] pointer-events-none z-[2]" />
